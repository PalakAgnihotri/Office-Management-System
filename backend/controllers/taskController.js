...
const updateTask = async (req, res) => {
  try {
    ...
    /* 3️⃣ If task assigned for first time */
...
Taskify System`
          ...
          console.log("EMAIL SENT:", emp[0].email);
    ...
    /* 4️⃣ If task reassigned */
    if (previousEmployee && newEmployee && Number(previousEmployee) !== newEmployee) {
